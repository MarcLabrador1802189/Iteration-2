...
class dieScene extends Phaser.Scene {
    constructor() {
        super("die");
    }
    preload() {
    ...
    create() {
        this.winText = this.add.text(450, 254, "You Died!", { font: '48px Arial', fill: '#ffffff' });
        ...
        this.uiscene = this.scene.manager.getScene('die');
